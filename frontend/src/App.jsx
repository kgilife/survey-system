...
function LinkedMatrixEditor({ admin, projectId, data, setError, getSchema, q, onChange }) {
  ...
  const addPrompt = () => {
    ...
    setPrompts([...prompts, {id, label:`新問項 ${prompts.length+1}`, type:"short", required:true, options:[], config:{}}]);
